        ...
        func updateViewFromModel() {
            for index in cardButtons.indices {
                ...
                if card.isFaceUp {
                    ...
                    button.backgroundColor = card.isMatched ? #colorLiteral(red: 0.4745098054, green: 0.8392156959, blue: 0.9764705896, alpha: 1) : #colorLiteral(red: 1, green: 0.8212699294, blue: 0.8877250552, alpha: 1)
                }
            }
