...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        //生成3个Teacher对象
        for i in 1...3{
            let temp = Teacher(title: "教授", firstName: "张san", lastName: "\(i)", age: 21, gender: .female, department: .one)
            teachers.append(temp)
        }
        //生成4个Student对象
        for i in 1..<5 {
            let temp = Student(stuNo: 2015110100 + i, firstName: "李si", lastName: "\(i)", age: 19, gender: .male, department: .two)
